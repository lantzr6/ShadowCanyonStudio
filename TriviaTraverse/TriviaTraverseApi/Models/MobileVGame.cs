...
namespace TriviaTraverseApi.Models
{
    public class MobileVGame
    {
        ...
        public MobileVGame(VGame vg, int playerid)
        {
            ...
            foreach (VGamePlayer vgp in vg.VGamePlayers)
            {
                ...
                if (vgp.PlayerId == playerid) { this.PlayerScore = vgp.Score; this.PlayerGameSteps = vgp.GameSteps; this.PlayerLastStepQuery = vgp.LastStepUpdate; }
            };
        }
    ...
    public class MobileVGameSection
    {
        ...
        public MobileVGameSection(VGamePlayerCategory pcat, int playerid) //used to create regular versus game sections
        {
